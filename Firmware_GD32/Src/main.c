...
const Note melodyRidin[] = {
    {NOTE_F4, 200}, {NOTE_OFF, 50}, {NOTE_F4, 200}, {NOTE_OFF, 50}, {NOTE_F4, 200}, {NOTE_OFF, 50}, {NOTE_F4, 400}, // They see me rollin'
    {NOTE_OFF, 100},
    {NOTE_E4, 200}, {NOTE_Eb4, 200}, {NOTE_Eb4, 400}, // They hatin'
    {NOTE_OFF, 100},
    // Patrolin'...
    {NOTE_Eb4, 200}, {NOTE_Eb4, 200}, {NOTE_Eb4, 200}, {NOTE_Eb4, 200}, 
    {NOTE_Db4, 200}, {NOTE_Db4, 200}, {NOTE_C4, 200}, {NOTE_C4, 400},
    // Ridin' dirty
    {NOTE_C4, 200}, {NOTE_C4, 200}, {NOTE_Bb3, 200}, {NOTE_Bb3, 200}, 
    {NOTE_Ab3, 200}, {NOTE_F3, 800},
    {NOTE_OFF, 1000} // Pause before loop
};

#define MELODY_LEN (sizeof(melodyRidin)/sizeof(Note))

uint32_t melodyStartTime = 0;
uint32_t melodyNoteIndex = 0;
FlagStatus melodyPlaying = RESET;
// ======================================================
#endif
...
int main (void)
{
  ...
  while(1)
    ...
    if (batteryVoltage > BAT_LOW_LVL1)
      ...
      // ================= MELODY LOGIC =================
      // Play "Ridin'" when moving (Speed > 50 or < -50)
      if (ABS(speed) > 50) {
          // Chair is moving
          if (melodyPlaying == RESET) {
              melodyPlaying = SET;
              melodyNoteIndex = 0;
          ...
          uint32_t now = millis();
          if (now - melodyStartTime >= melodyRidin[melodyNoteIndex].duration) {
              melodyStartTime = now;
              melodyNoteIndex++;
              if (melodyNoteIndex >= MELODY_LEN) melodyNoteIndex = 0;
          }
          
           // Set Buzzer
          buzzerFreq = melodyRidin[melodyNoteIndex].note;
